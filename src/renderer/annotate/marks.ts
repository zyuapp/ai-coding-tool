import type { ImageAnnotation, ImageAnnotationKind } from "../../domain/image-annotation";

export type AnnotationKind = ImageAnnotationKind;
export type Annotation = ImageAnnotation;
