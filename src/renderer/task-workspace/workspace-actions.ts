...
export function workspaceActions(dispatch: (input: WorkspaceInput) => Promise<void>) {
  return {
    ...
    dismissThread: (threadId: string) => dispatch({ type: "task.dismiss", taskId: threadId }),
    ...
    closeThreadTab: (taskId: string) => dispatch({ type: "view.close-thread-tab", taskId }),
    ...
    chooseJump: (threadId: string) => dispatch({ type: "view.jump-choose", taskId: threadId }),
