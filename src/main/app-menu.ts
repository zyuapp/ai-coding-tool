...
const UPDATE_MENU_ID = "app.check-for-updates";
...
export function installAppMenu(callbacks: { onCheckForUpdates: () => void; onOpenSourceLicenses: () => void }) {
  const checkForUpdates: MenuItemConstructorOptions = { id: UPDATE_MENU_ID, label: "Check for Updates…", click: callbacks.onCheckForUpdates };
