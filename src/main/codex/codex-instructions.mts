...
import { crewInstructions } from "../agent/crew-instructions.mjs";
...
export function codexInstructions(channel: RunChannel, crewRole?: CrewRole) {
  return [DEVELOPER_INSTRUCTIONS, ...crewInstructions(crewRole), ...(channel === "side" ? [SIDE_CHAT_INSTRUCTIONS] : [])].join("\n\n");
}
