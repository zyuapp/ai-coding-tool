...
import { expandThreadHandles, handleTokenAt, rankThreadHandles, threadHandles, threadLink, threadReference, threadSlug } from "../src/domain/thread-handles.ts";
import type { ThreadHandleOption } from "../src/domain/thread-handles.ts";

function option(id: string, title: string, overrides: Partial<Omit<ThreadHandleOption, "handle">> = {}): Omit<ThreadHandleOption, "handle"> {
