...
import { formatReset, formatShare, planLabel } from "../dist/main/domain/plan-usage.js";
import { readPlanUsage, toPlanUsage } from "../dist/main/main/agent/plan-usage.mjs";

function sessionFactory(methods, capture = {}) {
...
test("a usage report becomes the windows the panel draws, newest window first", () => {
  const usage = toPlanUsage(report);
