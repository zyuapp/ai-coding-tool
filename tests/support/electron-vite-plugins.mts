...
export function fakePlugins(computerUse: boolean, updater = false): Plugin[] {
  const plugins: Plugin[] = [{
    ...
    load(id) {
      if (id === "\0fake-electron") return "const e = globalThis.__aicodingtoolElectron; export const app=e.app, Menu=e.Menu, BaseWindow=e.BaseWindow, BrowserWindow=e.BrowserWindow, desktopCapturer=e.desktopCapturer, dialog=e.dialog, globalShortcut=e.globalShortcut, ipcMain=e.ipcMain, nativeImage=e.nativeImage, nativeTheme=e.nativeTheme, net=e.net, powerMonitor=e.powerMonitor, powerSaveBlocker=e.powerSaveBlocker, Notification=e.Notification, protocol=e.protocol, screen=e.screen, session=e.session, shell=e.shell, systemPreferences=e.systemPreferences, utilityProcess=e.utilityProcess, WebContentsView=e.WebContentsView;";
    },
  }, {
