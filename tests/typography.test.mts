...
function blocks(attribute: string) {
...
function bundled(fonts: readonly { id: string }[], fallback: string) {
...
test("every family the stylesheet names is one the app bundles a face for", async () => {
  ...
  for (const [attribute, token] of [["data-ui-font", "--ui-font"], ["data-mono-font", "--mono"]] as const) {
