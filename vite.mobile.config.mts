...
const MOBILE_LICENSE = "legal/MOBILE-THIRD-PARTY-LICENSES.md";
  ...
  return {
    ...
    closeBundle: {
      ...
      handler() {
        ...
        const licenses = htmlText(readFileSync(resolve(OUT, MOBILE_LICENSE), "utf8"));
        html = html.replace("</body>", `<template id="third-party-licenses">${licenses}</template></body>`);
